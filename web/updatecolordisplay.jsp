            ...
            <form action="ColorController" method="GET">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <input type="text" name="id" value="${updateColordisplay.id}" readonly class="form-control">
                            </td>
                            <td>
                                <input type="text" name="name" value="${updateColordisplay.name}" class="form-control">
                            </td>
                        </tr>
                    </tbody>
                </table>
