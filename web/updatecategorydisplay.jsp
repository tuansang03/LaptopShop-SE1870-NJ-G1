            ...
            <form action="CategoryController" method="GET">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <input type="text" name="id" value="${updatecategorydisplay.id}" readonly class="form-control">
                            </td>
                            <td>
                                <input type="text" name="name" value="${updatecategorydisplay.name}" class="form-control">
                            </td>
                        </tr>
                    </tbody>
                </table>
