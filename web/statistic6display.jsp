            ...
            <div class="form-group">
                ...
                <select id="revenueType" class="form-control" onchange="updateChartType()">
                    ...
                    <option value="top5Product" <c:if test="${action2 != null}">selected</c:if>>Top 5 Products</option>
                        <option value="workProductivity">Work Productivity</option> <!-- Tùy chọn mới -->
                    </select>
                </div>
            ...
            <c:forEach var="item" items="${list}">
                    ...
                    function updateChartType() {
                        ...
                        if (selectedType === "brand") {
                            ...
                            window.location.href = 'SaleStatisticController2?service=myWork'; // Chuyển đến servlet cho Work Productivity
                        }
                    }
        </script>
    </body>
