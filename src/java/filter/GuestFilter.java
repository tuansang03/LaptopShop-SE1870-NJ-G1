...
public class GuestFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        User getCurrentSale = (User) session.getAttribute("sale");
        User getCurrentAdmin = (User) session.getAttribute("admin");
        if(getCurrentUser==null && getCurrentAdmin == null && getCurrentSale == null){
